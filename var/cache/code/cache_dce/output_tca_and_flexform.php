...
if (\T3\Dce\Compatibility::isTypo3Version('10.0.0')) {
    $GLOBALS['TCA']['tt_content']['types']['dce_gallery']['previewRenderer'] =
...
--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.extended';
if (\T3\Dce\Compatibility::isTypo3Version('10.0.0')) {
    $GLOBALS['TCA']['tt_content']['types']['dce_teasers0']['previewRenderer'] =
        \T3\Dce\Components\BackendView\DcePreviewRenderer::class;
}
...
--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.extended';
if (\T3\Dce\Compatibility::isTypo3Version('10.0.0')) {
    $GLOBALS['TCA']['tt_content']['types']['dce_team']['previewRenderer'] =
        \T3\Dce\Components\BackendView\DcePreviewRenderer::class;
}
...
--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.extended';
if (\T3\Dce\Compatibility::isTypo3Version('10.0.0')) {
    $GLOBALS['TCA']['tt_content']['types']['dce_visual']['previewRenderer'] =
        \T3\Dce\Components\BackendView\DcePreviewRenderer::class;
}
...
--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.extended';
if (\T3\Dce\Compatibility::isTypo3Version('10.0.0')) {
    $GLOBALS['TCA']['tt_content']['types']['dce_quotes']['previewRenderer'] =
        \T3\Dce\Components\BackendView\DcePreviewRenderer::class;
}
