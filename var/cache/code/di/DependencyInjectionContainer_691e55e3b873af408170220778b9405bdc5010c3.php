 ...
 */
class DependencyInjectionContainer_691e55e3b873af408170220778b9405bdc5010c3 extends Container
{
    ...
    protected function getIconsDecorated28Service()
    {
        ...
        return $this->services['icons_decorated_28'] = $a->extendService('rte_config', 'icons', $this, $a->extendService('jd_ogmeta', 'icons', $this, $a->extendService('helhum/typo3-console', 'icons', $this, $a->extendService('dce', 'icons', $this, $a->extendService('viewpage', 'icons', $this, $a->extendService('tstemplate', 'icons', $this, $a->extendService('t3editor', 'icons', $this, $a->extendService('sys_note', 'icons', $this, $a->extendService('info', 'icons', $this, $a->extendService('felogin', 'icons', $this, $a->extendService('extensionmanager', 'icons', $this, $a->extendService('beuser', 'icons', $this, $a->extendService('belog', 'icons', $this, $a->extendService('rte_ckeditor', 'icons', $this, $a->extendService('setup', 'icons', $this, $a->extendService('seo', 'icons', $this, $a->extendService('form', 'icons', $this, $a->extendService('impexp', 'icons', $this, $a->extendService('filelist', 'icons', $this, $a->extendService('fluid_styled_content', 'icons', $this, \TYPO3\CMS\Dashboard\ServiceProvider::configureIcons($this, \TYPO3\CMS\Frontend\ServiceProvider::configureIcons($this, \TYPO3\CMS\Backend\ServiceProvider::configureIcons($this, $a->extendService('recordlist', 'icons', $this, \TYPO3\CMS\Install\ServiceProvider::configureIcons($this, \TYPO3\CMS\Fluid\ServiceProvider::configureIcons($this, \TYPO3\CMS\Extbase\ServiceProvider::configureIcons($this, \TYPO3\CMS\Core\ServiceProvider::configureIcons($this, \TYPO3\CMS\Core\ServiceProvider::getIcons($this)))))))))))))))))))))))))))));
    }
